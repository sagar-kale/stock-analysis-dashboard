    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">Loading mutual fund recommendations...</h2>
    ...
    <main className="flex min-h-screen flex-col p-4 md:p-24">
      ...
      <div className="mt-16 md:mt-0">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">Top Performing Mutual Funds</h1>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {data?.top_mutual_funds?.map((fund, index) => (
                <div key={fund} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center">
                    <div className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-100 font-bold rounded-full w-8 h-8 flex items-center justify-center mr-3">
                      {index + 1}
                    </div>
            ...
            <div className="mt-8">
              ...
              <p className="mb-2">These mutual funds have been selected based on a comprehensive analysis of:</p>
              ...
              <p>The ranking algorithm weighs these factors to identify mutual funds with the best combination of returns and risk characteristics.</p>
            </div>
